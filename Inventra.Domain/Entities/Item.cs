...
namespace Inventra.Domain.Entities
{
    public class Item
    {
        ...
        [MaxLength(500)] public string? CustomString1Value { get; private set; }
        [MaxLength(500)] public string? CustomString2Value { get; private set; }
        [MaxLength(500)] public string? CustomString3Value { get; private set; }
        ...
        [MaxLength(2000)] public string? CustomLink1Value { get; private set; }
        [MaxLength(2000)] public string? CustomLink2Value { get; private set; }
        [MaxLength(2000)] public string? CustomLink3Value { get; private set; }

        [MaxLength(2000)] public string? ImageUrl { get; private set; }
        ...
        public void UpdateValues(
            ...
            decimal? int1, decimal? int2, decimal? int3,
            ...
            string? imageUrl)
        {
            ...
            CustomString2Value = str2;
            CustomString3Value = str3;
            CustomInt1Value = int1;
            CustomInt2Value = int2;
            CustomInt3Value = int3;
            CustomText1Value = text1;
            CustomText2Value = text2;
            CustomText3Value = text3;
            CustomBool1Value = bool1;
            CustomBool2Value = bool2;
            CustomBool3Value = bool3;
            CustomLink1Value = link1;
            CustomLink2Value = link2;
            CustomLink3Value = link3;
            ImageUrl = imageUrl;
            UpdatedAt = DateTime.UtcNow;
        }
