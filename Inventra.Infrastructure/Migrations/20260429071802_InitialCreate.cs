        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CustomString1Shown = table.Column<bool>(type: "bit", nullable: false),
                    CustomString2Name = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CustomString2Shown = table.Column<bool>(type: "bit", nullable: false),
                    CustomString3Name = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CustomString3Shown = table.Column<bool>(type: "bit", nullable: false),
                    CustomInt1Name = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CustomInt1Shown = table.Column<bool>(type: "bit", nullable: false),
                    CustomInt2Name = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CustomInt2Shown = table.Column<bool>(type: "bit", nullable: false),
                    CustomInt3Name = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CustomInt3Shown = table.Column<bool>(type: "bit", nullable: false),
                    CustomText1Name = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CustomText1Shown = table.Column<bool>(type: "bit", nullable: false),
                    CustomText2Name = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CustomText2Shown = table.Column<bool>(type: "bit", nullable: false),
                    CustomText3Name = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CustomText3Shown = table.Column<bool>(type: "bit", nullable: false),
                    CustomBool1Name = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CustomBool1Shown = table.Column<bool>(type: "bit", nullable: false),
                    CustomBool2Name = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CustomBool2Shown = table.Column<bool>(type: "bit", nullable: false),
                    CustomBool3Name = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CustomBool3Shown = table.Column<bool>(type: "bit", nullable: false),
                    CustomLink1Name = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CustomLink1Shown = table.Column<bool>(type: "bit", nullable: false),
                    CustomLink2Name = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CustomLink2Shown = table.Column<bool>(type: "bit", nullable: false),
                    CustomLink3Name = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CustomLink3Shown = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InventorySequence", x => x.InventoryId);
                    table.ForeignKey(
                        name: "FK_InventorySequence_Inventories_InventoryId",
                        column: x => x.InventoryId,
                        principalTable: "Inventories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CustomInt1Value = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    CustomInt2Value = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    CustomInt3Value = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FixedValue = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CustomIdElements_CustomIdFormats_FormatId",
                        column: x => x.FormatId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomIdElements_FormatId",
